...
function PopoverPopupState({ classes }) {
    ...
    return (
        <div>
            <Avatar style={{ margin: '-10px -35px 0 0', cursor: 'pointer', background: "#114338" }} {...stringAvatar(sessionStorage.getItem("nome") + " " + sessionStorage.getItem("apelido"))} onClick={(event) => { handleClick(event) }} />
